...
for token in token_hasil_stopword_removal:
    token_hasil_stemming.append(ps.stem(token))
print("Token Hasil Stemming : ")
...
token_hasil_stemming_sastrawi = []
for token in token_hasil_stopword_removal_sastrawi:
    token_hasil_stemming_sastrawi.append(stemmer.stem(token))
print("Token Hasil Stemming (Sastrawi) : ")
print(token_hasil_stemming_sastrawi)
print("")